...
4. 이후의 설계 작업은 설계 도구를 사용
   ...
   => 논리 합성 도구는 RTL 표현을 ***게이트 수준 net-list(회로)***로 바꾸어줌
...
2) 바틈업 설계 : 탑다운방법과는 반대의 흐름을 가짐; 하위->상위

ex) dff는 and나 or게이트, Tr.을 이용해 만듦

바틈업 의 흐름과 탑다운의 흐름이 DFF의 단계에서 만남ㅁ
...
​	=> 템플릿으로부터 객체를 생성하는 것을 **파생(instantiation)**, **객체를 인스턴스화**
